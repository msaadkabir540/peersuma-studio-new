...
import { EmbedWidgetInterface, customEmbedWidgetThumbInterface } from "./embed-widget-interface";
  ...
  return (
    ...
    >
      <div
        ...
        style={{ color: thumbnailTitleColor, backgroundColor: WidgetBackgroundColor }}
        aria-label={item?.name}
      >
        {item?.name}
      </div>
      ...
      >
        <img
          style={{
            border: `1px solid ${thumbnailColor}`,
            opacity: 0.7,
          }}
        ...
        {!selected && (
          <>
            <div className={style.thumbTimeContainer}>{fullTime}</div>
